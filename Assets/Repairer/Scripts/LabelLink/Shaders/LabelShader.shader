...
Shader "HoloWorld/Hightech Label Shader"
{
    Properties
    {
		_SideX("SideX", Range(-1, 1)) = 1
		_SideY("SideY", Range(-1, 1)) = 1

		_AngleCoeff("Angle Coeffitient", Range(-10, 10)) = 1
		_RatioX("Ratio X", Range(0, 1)) = 0.3
		_Thin("Thin", Range(0, 1)) = 0.01
		_PercentOfAppearing("Percent of Appearing", Range(0, 1)) = 0
